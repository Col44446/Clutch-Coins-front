  ...
  useEffect(() => {
    const fetchTrendingGames = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/featured/trending`, { headers });
        ...
        >
          {trendingGames.map((game) => (
            <article
              ...
              className="min-w-[100px] sm:min-w-[120px] bg-indigo-950/60 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-white/10 overflow-hidden group relative snap-start cursor-pointer"
            ...
            >
              ...
              {/* Image Container */}
              <div className="relative w-full h-full bg-black/10 flex items-center justify-center overflow-hidden">
                <img
                ...
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 to-transparent text-white text-center py-2 px-2 z-20">
                  <h3 className="text-xs sm:text-sm font-semibold drop-shadow-lg line-clamp-1">
